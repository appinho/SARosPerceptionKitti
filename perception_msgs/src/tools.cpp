...
MatrixXf Tools::getImage2DBoundingBox(
	...
	float half_length = o.length / 2; // - 2 * GRID_CELL_SIZE;
	float half_width = o.width / 2; // - 2 * GRID_CELL_SIZE;
	...
	std::cout << "Object " << o.id << " at " << o.velo_pose.point.x
		<< " " << o.velo_pose.point.y << std::endl;
	std::cout << "Ori " <<  o.orientation << " L/O " << half_length << " W/A " << half_width << std::endl;
	std::cout << cos_l << " " << sin_w << " " << sin_l << " " << cos_w << std::endl << std::endl;
